...
def tema(fig,h=430):
    fig.update_layout(height=h,paper_bgcolor="rgba(0,0,0,0)",plot_bgcolor="rgba(0,0,0,0)",font_color="#CAD5E2",legend_title_text="",legend=dict(orientation="h",x=.5,xanchor="center",y=1.04,yanchor="bottom",entrywidth=.30,entrywidthmode="fraction"),margin=dict(l=25,r=55,t=90,b=50))
...
if not ARQ.is_file(): st.error("Base de turnos não encontrada."); st.info("Execute o Atualizador Único V13."); st.stop()
