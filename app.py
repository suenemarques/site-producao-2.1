...
st.markdown(
    """
    <style>
    /* Fundo tecnológico animado: rede de linhas neon e pontos conectados. */
    .stApp {
      background:
    ...
    .kpi-card {
      background:linear-gradient(145deg,rgba(16,30,48,.92),rgba(12,24,40,.88));
      backdrop-filter:blur(10px); border:1px solid rgba(56,189,248,.18);
      border-radius:16px; padding:1.05rem 1.1rem; min-height:185px;
      box-shadow:0 14px 35px rgba(0,0,0,.24), inset 0 1px 0 rgba(255,255,255,.025);
      transition:transform .22s ease, border-color .22s ease, box-shadow .22s ease;
    }
    .kpi-card:hover {transform:translateY(-3px); border-color:rgba(56,189,248,.38);
      box-shadow:0 18px 42px rgba(0,0,0,.30),0 0 22px rgba(14,165,233,.07);}
    ...
    .mini-card {background:rgba(13,26,43,.90);backdrop-filter:blur(10px);border:1px solid #20334A;border-radius:14px;padding:1rem;}
